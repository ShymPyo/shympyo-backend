...
public class RentalController {
    ...
    @Operation(
            ...
            requestBody = @RequestBody(
                    required = true,
                    content = @Content(
                            schema = @Schema(implementation = EnterRequest.class),
    ...
    public ResponseEntity<?> enter(
            @org.springframework.web.bind.annotation.RequestBody EnterRequest request,
    ...
    public ResponseEntity<?> getRental(
        ...
        List<CurrentRentalResponse> rental = rentalService.getRental(user.getId());
        return ResponseUtil.success(rental);
    }
